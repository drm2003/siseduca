...
public class BolsaFabricaTest {
	...
	public Bolsa criaBolsa() {
		...
		contasAReceber_Bolsa.add(ContaAReceber_BolsaFabricaTest.getInstance().criaContasAReceber_Bolsa());
		contasAReceber_Bolsa.add(ContaAReceber_BolsaFabricaTest.getInstance().criaContasAReceber_Bolsa());
	...
	public Bolsa criaBolsaPersistido(EntityManager em) {
		...
		// contas a receber e bolsa
		ContaAReceber_BolsaDao contasAReceber_BolsaDao = new ContaAReceber_BolsaDao(em);
