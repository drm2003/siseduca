...
@Entity
@Table(name = "TipoDeDisciplina")
public class TipoDeDisciplina implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoDeDisciplina other = (TipoDeDisciplina) obj;
		if (descricao == null) {
	...
	public String toString() {
		return "TipoDeDisciplina [descricao=" + descricao + "]";
	}
}
