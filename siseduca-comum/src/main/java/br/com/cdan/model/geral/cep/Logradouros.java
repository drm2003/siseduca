...
public class Logradouros implements Serializable {
	...
	public void setPreposicaoInicialLogradouro(
			String preposicaoInicialLogradouro) {
	...
	public String toString() {
		return "Logradouros [cep=" + cep + ", chave=" + chave + ", UF=" + UF
				+ ", tipoLogradouro=" + tipoLogradouro + ", tituloLogradouro="
				+ tituloLogradouro + ", preposicaoInicialLogradouro="
				+ preposicaoInicialLogradouro + ", nome=" + nome
				+ ", bairroInicioLogradouro=" + bairroInicioLogradouro
