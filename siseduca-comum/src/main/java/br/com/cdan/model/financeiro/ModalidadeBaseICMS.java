...
@Entity
@Table(name = "ModalidadeBaseICMS")
public class ModalidadeBaseICMS implements Serializable {
	...
	@OneToOne(mappedBy = "modalidadeBaseICMS")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ModalidadeBaseICMS other = (ModalidadeBaseICMS) obj;
		if (descricao == null) {
	...
	public String toString() {
		return "ModalidadeBaseICMS [descricao=" + descricao + "]";
	}
}
